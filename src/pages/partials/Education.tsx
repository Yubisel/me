...
const Education = () => {
  return (
    <section id="services">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 text-gray-400 bg-gray-900 body-font">
        <div className="container px-5 pt-4 pb-24 mx-auto flex flex-wrap">
        ...
        <div className="container px-5 pt-4 pb-24 mx-auto flex flex-wrap">
          <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pr-12 lg:text-right text-center order-2 lg:order-1">
            <div className="flex flex-col mb-10 lg:items-end items-center">
              <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-gray-800 text-indigo-400 mb-5">
                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6" viewBox="0 0 24 24">
                  <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>
                </svg>
          ...
          <div className="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden order-1 lg:order-2">
            <img alt="feature" className="object-cover object-center h-full w-full" src="https://dummyimage.com/460x500" />
          </div>
        </div>
      </div>
